...
Public Sub TrayModify(ByVal text As String)
    ShellTrayModifyTip (text)
End Sub
...
With nid
    ...
    .szTip = "Devil Inf Killer 1.0.0" & vbNullChar
...
Private Sub ShellTrayModifyTip(ByVal text As String)
    Dim nid As NOTIFYICONDATA
    If NOTIFYICONDATA_SIZE = 0 Then SetShellVersion
